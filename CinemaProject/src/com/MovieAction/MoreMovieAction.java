 ...
 */
@WebServlet("/Main/MoreMovie")
public class MoreMovieAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MoreMovieAction() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<MovieBean> arr = dao.MovieSearchList(word, startRow, endRow);
		int count = dao.MovieSearchCount(word);
		...
		RequestDispatcher dispatcher = request
				.getRequestDispatcher("MainSearchMovie.jsp");
