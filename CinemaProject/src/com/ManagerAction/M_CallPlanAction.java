 ...
 */
@WebServlet("/Manager/M_CallPlan.do")
public class M_CallPlanAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public M_CallPlanAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MovieBean> arr = dao.MovieCallPlan(startRow, endRow);
		int count = dao.MoviePlanCount();
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("Manager_Main.jsp?page=Manager_Movie&source1=Movie_Plan");
