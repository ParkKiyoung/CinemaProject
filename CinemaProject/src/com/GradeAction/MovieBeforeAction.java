...
/**
 * Servlet implementation class SelectedBeforeAction
 */
@WebServlet("/Grade/MovieBefore.do")
public class MovieBeforeAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MovieBeforeAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<GradeBean> SArr = dao.SelectedBeforeGrade(SelectedValue,startRow,endRow);
		int count = dao.SelectedBeforeGradeCount(SelectedValue);
		...
		request.setAttribute("MovieBeforeList", SArr);
