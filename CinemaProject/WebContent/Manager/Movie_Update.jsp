...
<script>
	...
	function getPage(pageNum) {
		$("#Manager_Header").load("M_CallList.do", {
			"pageNum" : pageNum,
		}, function(data) {
			$("#Main_Body").html(data)
		});
					...
					<table id="MP_Table" width="100%">
						...
						<tr>
							<td colspan="7" align="right">
								<input id="MP_Btn" type="button" value="수정" onclick="javascript:movieUpdate(${mov.num })">
								<input id="MP_Btn" type="button" value="삭제" onclick="javascript:movieDelete(${mov.num })"></td>
					</table>
				</c:forEach>
				</td>
		</tr>
